...
export default function App(){
 ...
 return <div className={'portfolio '+(dark?'dark':'light')}>
   ...
   <main id="top">
    ...
    <section className="contact"><div className="reveal"><p className="eyebrow">Have a role or project in mind?</p><h2>Let’s put a good idea<br/><em>on the screen.</em></h2><div className="contactLinks"><a href="mailto:shobhitg947@gmail.com">Mail ↗</a><a href="https://github.com/shobhit26-09" target="_blank" rel="noreferrer">GitHub ↗</a><a href="https://leetcode.com/u/shobhitg947" target="_blank" rel="noreferrer">LeetCode ↗</a><a href="https://www.linkedin.com/in/shobhit-gupta-867b12223/" target="_blank" rel="noreferrer">LinkedIn ↗</a><a href="/Shobhit_Resume.pdf" target="_blank" rel="noreferrer">Resume ↗</a></div></div></section>
